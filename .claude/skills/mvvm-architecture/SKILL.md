...
bool cb_xxx_changed(void *priv, obs_properties_t *props, obs_property_t *, obs_data_t *settings) {
    ...
    props_ui_with_preserved_scroll([d]() {
        ...
        schedule_pulldown_row_inject(d->context);       // タブ 2 固有
        schedule_stepper_inject(d->context);            // タブ 2 固有
        schedule_help_callout_inject(d->context);       // タブ 2 固有
    });
    return true;
}
...
| タブ | 常に必要 | タブ固有 |
|---|---|---|
| 0 (出演者名) | color_button_row | text_button, button_bar |
| 1 (トンネル) | color_button_row | text_button, path_mode_row, help_callout, button_bar |
| 2 (WS配信) | color_button_row | pulldown_row, stepper, help_callout, button_bar |
| 3 (URL共有) | color_button_row | url_table, button_bar |
| 4 (RTSP計測) | color_button_row | flow_progress, help_callout, path_mode_row, mode_text_row, button_bar |
| 5 (WS計測) | color_button_row | flow_progress, flow_table, button_bar |
| 6 (微調整) | color_button_row | stepper, help_callout, delay_diagram, delay_table |
