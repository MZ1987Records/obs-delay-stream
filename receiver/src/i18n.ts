...
const I18N_RESOURCES: Record<'ja' | 'en', I18nResource> = {
  ja: {
    translation: {
      ...
      diagram: {
        delay: '自動調整ディレイ',
        delayDesc: 'は上記の値に基づいて自動的に算出されます',
        ws: 'WS配信遅延',
        env: '環境遅延',
        buf: '再生バッファ',
        avatar: 'アバター遅延',
  ...
  en: {
    translation: {
      ...
      diagram: {
        delay: 'Auto-Adjusted Delay',
        delayDesc: 'is automatically calculated based on the values above',
        ws: 'WS Delivery Latency',
        env: 'Env. Latency',
        buf: 'Playback Buffer',
        avatar: 'Avatar Latency',
